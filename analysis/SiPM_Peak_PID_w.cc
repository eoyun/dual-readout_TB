...
int main(int argc, char** argv) {
    ...
    float psPIDcut = 13630 * 4.f; // This is not the proper way to set cut!! Details will be presented in workshop
    ...
    */
    ...
    TH1F *IntADC_S = new TH1F("peakADC_S",";intADC;evt",21000,-1000,20000);
    TH1F *IntADC_C = new TH1F("peakADC_C",";intADC;evt",11000,-1000,10000);
    TH2F *IntADC_SvsC = new TH2F("peakADC_SvsC",";intADC(S);intADC(C)",1000,-1000,4000,1000,-1000,2000);
    TH1F *IntADC_S_PID = new TH1F("peakADC_S_PID",";intADC;evt",21000,-1000,20000);
    TH1F *IntADC_C_PID = new TH1F("peakADC_C_PID",";intADC;evt",11000,-1000,10000);
    TH2F *IntADC_SvsC_PID = new TH2F("peakADC_SvsC_PID",";intADC(S);intADC(C)",1000,-1000,4000,1000,-1000,2000);
    TH1F *FWHM_S[200];
    TH1F *FWHM_C[200];
    for (int i=0;i<200;i++){
    ...
    TFile * root_fp = new TFile(Form("Peak_%d_SiPM_PID_w_250.root",runNum),"recreate");
    for (int i=0;i<200;i++){
        FWHM_S[i]->Write();
        FWHM_C[i]->Write();
    }
